...
for i = 1:nparts
    switch i==1
        case 1 
            eval_str = [...
                'particles{',num2str(i),'}.Energy.U_total(',...
                'H1_tot{',num2str(i),'}(time,angles),',...
                'H2_tot{',num2str(i),'}(time,angles),',...
                'H3_tot{',num2str(i),'}(time,angles),',...
                'm1(angles(',num2str(i),'),angles(',num2str(nparts+i),')),',...
                'm2(angles(',num2str(i),'),angles(',num2str(nparts+i),')),',...
                'm3(angles(',num2str(i),'),angles(',num2str(nparts+i),')),',...
                'particles{',num2str(i),'}.SourceFields.static.S1(time),',...
                'particles{',num2str(i),'}.SourceFields.static.S2(time),',...
                'particles{',num2str(i),'}.SourceFields.static.S3(time),',...
                'particles{',num2str(i),'}.SourceFields.static.S4(time),',...
                'particles{',num2str(i),'}.SourceFields.static.S5(time),',...
                'particles{',num2str(i),'}.SourceFields.static.S6(time))'...
                ];
        case 0 
            eval_str = [eval_str,' + particles{',num2str(i),'}.Energy.U_total(',...
                'H1_tot{',num2str(i),'}(time,angles),',...
                'H2_tot{',num2str(i),'}(time,angles),',...
                'H3_tot{',num2str(i),'}(time,angles),',...
                'm1(angles(',num2str(i),'),angles(',num2str(nparts+i),')),',...
