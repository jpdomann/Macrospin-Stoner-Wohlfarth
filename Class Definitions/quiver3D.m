function [hHead,hStem] = quiver3D(posArray, magnitudeArray, arrowColors, stemRatio)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    hold on;    
    hHead= gobjects(1,numArrows);
    hStem = hHead;
    for i=1:numArrows
        tempHandle = arrow3D(posArray(i,:), magnitudeArray(i,:), arrowColors(i,:), stemRatio);
        hStem(i) = tempHandle{1};
        hHead(i) = tempHandle{2};
    end
